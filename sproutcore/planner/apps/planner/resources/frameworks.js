...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', static_url('/img/check.png'));
    else this.set('value', static_url('/img/uncheck.png'));
  ...
  toggleCompletion: function(){
    ...
    if(isComplete) this.set('value', static_url('/img/uncheck.png'));
    if(!isComplete) this.set('value', static_url('/img/check.png'));
  }
});
