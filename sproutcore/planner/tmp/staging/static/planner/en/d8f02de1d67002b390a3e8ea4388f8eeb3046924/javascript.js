...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  top: .13,
  width: function(){
    return this.get('parentView').get('checkWidth');
  }.property(),
  classNames: ['pointer'],
  useCanvas: NO,
  init: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/d8f02de1d67002b390a3e8ea4388f8eeb3046924/source/resources/img/ajax-loader.gif',
      })
    }),
