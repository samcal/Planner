...
Planner.Animation = SC.Object.create({
	...
	hide: function(views){
		if(views instanceof Array){
			if(views.length == 1) SC.warn('The hide method now supports single objects.')
	...
	show: function(views){
		if(views instanceof Array){
			if(views.length == 1) SC.warn('The show method now supports single objects.')
			views.forEach(function(view){
	...
	fadeIn: function(views, time){
		...
		if(views instanceof Array){
			if(views.length == 1) SC.warn('The fadeIn method now supports single objects.');
			views.forEach( function(view){
	...
	fadeOut: function(views, time){
		if(!time) var time = 700;
		if(views instanceof Array){
			if(views.length == 1) SC.warn('The fadeOut method now supports single objects.');
			views.forEach( function(view){
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/3ef9927d079adc796b9a2ac104153c2e3e960341/source/resources/img/ajax-loader.gif',
      })
    }),
