...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/uncheck.png');
...
Planner.EventView = Planner.Wrapper.extend({
  ...
  render: function(){
    arguments.callee.base.apply(this,arguments);
    Planner.Animation.sizeText(this, .8);
  },
  updatePosition: function(){
    this.adjust({
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/a2471d54a2d987944c512fb0f46be94d795ff371/source/resources/img/ajax-loader.gif',
      })
    }),
