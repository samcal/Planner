...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/check.png');
  }
})
...
Planner.EventList = SC.ScrollView.extend({
  ...
  requiredProperties: 'events eventLeftOffset eventTopOffset eventHeight eventWidth'.w(),
  init: function(){
    arguments.callee.base.apply(this,arguments);
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/bd2a972dca365cc97db26e791dc56a7c824d0f80/source/resources/img/ajax-loader.gif',
      })
    }),
