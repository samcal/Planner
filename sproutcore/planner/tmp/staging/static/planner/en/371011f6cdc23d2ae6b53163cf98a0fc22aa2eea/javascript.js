...
Planner.Calendar = SC.Object.create({
	...
	monthName: function(){return SC.DateTime.monthNames[this.get('monthnum')]}.property(),
...
Planner.WeekCellController = SC.Object.extend({
  ...
  updateEvents: function() {
    ...
    var allEvents = Planner.store.find(courseQ).firstObject().get('events');
    var todayEvents = [];
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/371011f6cdc23d2ae6b53163cf98a0fc22aa2eea/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/371011f6cdc23d2ae6b53163cf98a0fc22aa2eea/source/resources/img/ajax-loader.gif',
      })
    }),
