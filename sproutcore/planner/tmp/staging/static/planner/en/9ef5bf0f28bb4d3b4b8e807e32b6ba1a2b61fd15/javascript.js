...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/uncheck.png');
  ...
  toggleCompletion: function(){
    ...
    if(isComplete) this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/check.png');
  }
});
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/9ef5bf0f28bb4d3b4b8e807e32b6ba1a2b61fd15/source/resources/img/ajax-loader.gif',
      })
    }),
