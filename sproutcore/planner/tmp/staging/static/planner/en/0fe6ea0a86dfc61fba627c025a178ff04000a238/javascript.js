...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  eventHeight: function(){
    ...
    SC.info(Planner.Utility.id(this.get('parentView')))
    SC.info($(Planner.Utility.id(this.get('parentView'))).css('height').slice(0,=2));
    return $(Planner.Utility.id(this.get('parentView'))).css('height').slice(0,-2);
  }.property(),
  classNames: ['pointer'],
  useCanvas: NO,
  render: function(){
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/uncheck.png');
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/0fe6ea0a86dfc61fba627c025a178ff04000a238/source/resources/img/ajax-loader.gif',
      })
    }),
