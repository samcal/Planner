...
Planner.CalendarView = SC.View.extend({
  ...
  init: function(){
    ...
    days.forEach(function(item){
      header = SC.LableView.create({
        classNames: ['day-header'],
        init: function(){
          this.adjust{
            width: this.retrieve('colWidth'),
            height: .1,
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/3e099b6a873ea37ddec2dbcbd33f2f67a6bb5513/source/resources/img/ajax-loader.gif',
      })
    }),
