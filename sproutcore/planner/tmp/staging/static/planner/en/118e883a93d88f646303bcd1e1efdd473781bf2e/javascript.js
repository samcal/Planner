...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/uncheck.png');
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/118e883a93d88f646303bcd1e1efdd473781bf2e/source/resources/img/ajax-loader.gif',
      })
    }),
