...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  left: .02,
  height: function(){
    return .8 * this.get('currentHeight')
  }.property('currentHeight'),
  top: function(){
    return (this.get('currentHeight') - this.get('height'))/2;
  }.property('currentHeight'),
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/uncheck.png');
  }.observes('height'),
  mouseDown: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/cb29c604ccf04a18edb81ba41258bfd3bc42b3cc/source/resources/img/ajax-loader.gif',
      })
    }),
