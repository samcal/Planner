...
Planner.CheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/f46a61c39948d76b3e01a7e1700d74eca6d6b778/source/resources/img/ajax-loader.gif',
      })
    }),
