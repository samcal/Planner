...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/check.png');
  }
})
	  	...
	  	PROVIDING_CREDENTIALS: SC.State.design({
			...
			LOGIN_ERROR: SC.State.design({
				showError: function(error, num, num2){
	  			...
	  			Planner.Animation.fadeOut(Planner.getPath('loginPage.loginPane.loginBin.error'), 500);
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/42d31c1ef03e78ddb6f07c40e2b76138a8ba564f/source/resources/img/ajax-loader.gif',
      })
    }),
...
Planner.plannerPage = SC.Page.design({
  ...
  plannerPane: SC.MainPane.design({
    ...
    sideView: SC.View.design({
      ...
      eventList: Planner.EventList.create({isVisible: NO}),
    }),
