...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  init: function(){
    arguments.callee.base.apply(this,arguments);
    SC.info('Events:' + this.get('events'));
...
Planner.statechart = SC.Statechart.create({
  ...
  LOGGED_IN: SC.State.design({
	  ...
	  startUp: function(){
			...
			Planner.Animation.fadeIn([Planner.getPath('plannerPage.plannerPane.sideView'), Planner.getPath('plannerPage.plannerPane.mainView').get('layer')], 500)
	  },
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/2ccbab1cb41d97d4336299130be85ffbee906fe7/source/resources/img/ajax-loader.gif',
      })
    }),
