...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/uncheck.png');
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    this.get('parentView').get('parentView').contentViewFrameDidChange();
    this.get('parentView').get('parentView').contentViewDidChange();
    this.get('parentView').get('parentView').contentViewFrameDidChange();
    this.get('parentView').get('parentView').render();
   return YES;
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/03f79c7243c7ebdd70fd1c93644eb17da3e0d45b/source/resources/img/ajax-loader.gif',
      })
    }),
