...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/check.png');
  }
})
...
Planner.ScrollView = SC.CoreScrollView.extend({
  didScroll: function(){
    arguments.callee.base.apply(this,arguments);
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/uncheck.png');
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    this.get('parentView').get('parentView').tile();
   return YES;
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/9f712732efbcf92bf021cc0446a40ea6714b382c/source/resources/img/ajax-loader.gif',
      })
    }),
