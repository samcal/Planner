...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/uncheck.png');
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    this.get('parentView').get('parentView').get('verticalScrollerView').render();
   return YES;
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/7762d5bbda4f7830707f86d3cb04a3c3bac35bb9/source/resources/img/ajax-loader.gif',
      })
    }),
