...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/uncheck.png');
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/3a3e72afeaf304e79920cba8d691d4c3802f47f6/source/resources/img/ajax-loader.gif',
      })
    }),
