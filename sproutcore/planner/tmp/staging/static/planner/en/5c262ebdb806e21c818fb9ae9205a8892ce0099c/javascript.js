...
Planner.Utility = SC.Object.create({
	verbose: function(view, properties){
		for(property in properties){
			(view.get(property) == undefined) ? SC.warn(property + 'does not exist') : (view.get(property) == null) ? SC.warn('You forgot to define the required ' + property) : SC.info(property + ' = ' view.get(property));
		}
	},
	toId: function(arg){
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/check.png');
  }
})
...
Planner.EventList = SC.ScrollView.extend({
  ...
  requiredProperties: ['events', 'eventsCreated', 'eventViews', 'eventLeftOffset', 'eventTopOffset', 'eventHeight', 'eventWidth'],
	...
	init: function(){
		arguments.callee.base.apply(this,arguments);
    for(item : this.get('requiredProperties')){
      (this.get(item) == nul) ? SC.warn('EventList: The required property ' + item + ' was not supplied') : SC.info('EventList: ' + item + ' = ' + this.get('item'));
    }
	},
	retrieve: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/5c262ebdb806e21c818fb9ae9205a8892ce0099c/source/resources/img/ajax-loader.gif',
      })
    }),
