...
Planner = SC.Application.create(
  ...
  required: function(){
    for(var i = 0; i < this.get('requiredProperties').get('length'); i++){
      if(!Planner.Utility.isDefined(this.get(this.get('requiredProperties').objectAt(i))) SC.error(this.get('requiredProperties').objectAt(i) + ' is not defined!');
    }
  }
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/3a6facd080b2bffdb02c99e5b8a192ed4016abf4/source/resources/img/ajax-loader.gif',
      })
    }),
