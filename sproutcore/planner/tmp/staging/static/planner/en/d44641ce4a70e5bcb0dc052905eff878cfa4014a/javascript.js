...
Planner.CheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/check.png');
  }
})
  ...
  trace: YES,
	...
	LOADED: SC.State.design({ 
	  ...
	  enterState: function() {
	  	...
	  	SC.info('most recent for real');
	  	Planner.currentUser.checkLoginStatus();
	  },
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/d44641ce4a70e5bcb0dc052905eff878cfa4014a/source/resources/img/ajax-loader.gif',
      })
    }),
