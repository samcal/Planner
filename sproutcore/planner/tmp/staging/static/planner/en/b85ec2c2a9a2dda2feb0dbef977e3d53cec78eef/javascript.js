...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/check.png');
  }
})
...
Planner.WeekCell = Planner.EventList.extend({
  ...
  retrieve: function(){return Planner.WeekController.get(property);}
});
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/b85ec2c2a9a2dda2feb0dbef977e3d53cec78eef/source/resources/img/ajax-loader.gif',
      })
    }),
