...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/ff039157bbb0370b7f7da2c0e7e804214f174e07/source/resources/img/ajax-loader.gif',
      })
    }),
