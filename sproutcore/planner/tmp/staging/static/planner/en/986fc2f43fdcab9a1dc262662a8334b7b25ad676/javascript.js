...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/check.png');
  }
})
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    for(var i = 0; i < this.get('numEvents'); i++){
      ...
      if(!created){
        var superOrder, index, adjustPoint = this.get('eventOrder').indexOf(eventType), 0, -1;
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/986fc2f43fdcab9a1dc262662a8334b7b25ad676/source/resources/img/ajax-loader.gif',
      })
    }),
