...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  init: function(){
    arguments.callee.base.apply(this,arguments);
    SC.info(this.get('parentView').get('parentView'));
    SC.info('Parent View: ' + this.get('parentView').get('parentView'));
    SC.info('Parent View Events: ' + this.get('parentView').get('parentView').get('events'));
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/535fa3f619b135ff6e935ecc24af1ad19cbc32b2/source/resources/img/ajax-loader.gif',
      })
    }),
