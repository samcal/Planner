...
Planner.Animation = SC.Object.create({
	...
	SwitchBookmark: function(title, noHide){
		...
		if(!noHide) $(Planner.Utility.id(Planner.getPath('loginPage.loginPane.bookmark'))).animate({translateY: '-=35'}, 500);
		
		// Set a timer to execute the value reset and slide down to occur in 300 milliseconds. 
		SC.Timer.schedule({
			target: this, 
			action: function(){	
				 $(Planner.Utility.id(Planner.getPath('loginPage.loginPane.bookmark'))).animate({translateY: '+=35'}, 500);
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/a9a829d04f8adc9295aefa86fa65b3e321cc34cf/source/resources/img/ajax-loader.gif',
      })
    }),
