...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  left: .02,
  height: function(){
    SC.info('Event Height' + this.get('eventHeight'));
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/uncheck.png');
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/41d29be2e453c44a7656e62edb417e426ab6e288/source/resources/img/ajax-loader.gif',
      })
    }),
