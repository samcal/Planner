...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  init: function(){
    arguments.callee.base.apply(this,arguments);
    SC.info(this.get('parentView').get('parentView').get('events'));
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/04fa1f2a30b62133658b018ba007b541933e9b68/source/resources/img/ajax-loader.gif',
      })
    }),
