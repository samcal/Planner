...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/check.png');
  }
})
...
Planner.EventView = Planner.Wrapper.extend({
  ...
  top: function(){
    ...
    return this.get('parentView').get('eventTopOffset') + this.get('height')*this.get('index');
  }.property(),
  height: function(){
    return this.get('parentView').get('eventHeight') * this.get('parentView').get('currentHeight');
  }.property(),
  width: function(){
    SC.info('eyyy');
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/726b820f7c0b30be07ee49c5bc0d94ffa7e07e09/source/resources/img/ajax-loader.gif',
      })
    }),
