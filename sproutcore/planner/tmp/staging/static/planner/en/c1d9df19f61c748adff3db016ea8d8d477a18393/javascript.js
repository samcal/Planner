...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/check.png');
  }
})
...
Planner.EventView = Planner.Wrapper.extend({
  ...
  top: function(){
    SC.info(this.get('parentView').get('eventTopOffset'));
    SC.info(this.get('parentView').get('eventTopOffset')*this.get('listHeight'));
    SC.info(this.get('height'));
    SC.info(this.get('index'));
    SC.info(this.get('height')*this.get('index'));
    SC.info('-------------------------------------');
    return this.get('parentView').get('eventTopOffset')*this.get('listHeight') + this.get('height')*this.get('index');
  }.property(),
  height: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/c1d9df19f61c748adff3db016ea8d8d477a18393/source/resources/img/ajax-loader.gif',
      })
    }),
