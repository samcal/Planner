...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
	events: null, //binding of some sort
...
Planner.EventList = SC.ScrollView.extend({
	retrieve: function(){
		SC.info('You did not define the retrieve function to work with your current event list, or you just created an event list')
	}
	hasHorizontalScroller: NO,
	hasVerticalScroller: YES,
	classNames: ['event-list'],
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/12d78593af03fa9137ca206a630868113990a6c3/source/resources/img/ajax-loader.gif',
      })
    }),
