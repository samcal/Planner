...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/uncheck.png');
  ...
  toggleCompletion: function(){
    ...
    if(isComplete) this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/check.png');
  }
});
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/a7257c75441851b597f361e6b41017891f3aa6ae/source/resources/img/ajax-loader.gif',
      })
    }),
