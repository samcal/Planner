...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/uncheck.png');
  ...
  toggleCompletion: function(){
    ...
    if(isComplete) this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/check.png');
  }
});
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/8448034d6c1cca2601f01175165f69e665c07df3/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
