...
Planner.DayController = SC.Object.create({
  ...
  today: SC.DateTime.create(),
	...
	rightEvents: function(){
		events = [];
		for(var i = 0; i < Planner.Courses.get('length'); i++)
			events.push(Planner.Utility.filterByDate(Planner.Courses.objectAt(i).get('events'), this.get('rightDatePlanlef')));
		return events;
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/uncheck.png');
  ...
  toggleCompletion: function(){
    ...
    if(isComplete) this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/check.png');
  }
});
...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/ad044318b6b2264ab08cf776714c6cea6f94ed63/source/resources/img/ajax-loader.gif',
      })
    }),
