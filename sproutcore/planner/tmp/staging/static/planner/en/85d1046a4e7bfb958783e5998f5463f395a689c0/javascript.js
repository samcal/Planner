...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  init: function(){
    ...
    SC.info(this.get('parentView').get('events'));
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/85d1046a4e7bfb958783e5998f5463f395a689c0/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/85d1046a4e7bfb958783e5998f5463f395a689c0/source/resources/img/ajax-loader.gif',
      })
    }),
