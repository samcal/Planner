...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/check.png');
  }
})
...
Planner.Event = Planner.Wrapper.extend({
  ...
  type: function(){return Planner.Utility.type(this.get('content'));}.property('content'),
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
	update: function() {
    SC.warn('updating!');
    SC.info(this.get('numEvents'));
    SC.info(this.get('currentHeight'));
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/7648df5ddb552d424fa39e1c75373deaeddd2da3/source/resources/img/ajax-loader.gif',
      })
    }),
