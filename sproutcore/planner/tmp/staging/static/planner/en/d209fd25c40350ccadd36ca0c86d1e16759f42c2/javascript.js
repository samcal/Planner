...
Planner.WeekController = SC.Object.create({
  ...
  create: function(){
    ...
    if (firstDay.get('dayOfWeek') === 0) {
  	...
  	title = SC.LabelView.create({textAlign: SC.ALIGN_CENTER, layout: {width: 500, centerX: 0, top: .01}, classNames: ['title'], valueBinding: "Planner.WeekController.title"}),
...
Planner.EventView = Planner.Wrapper.extend({
  ...
  icon: SC.ImageView.design({
    layout: {width: .07, height: .8, left: .02, top: .1},
    useCanvas: NO,
    init: function(){
      arguments.callee.base.apply(this,arguments);     
      if(this.get('parentView').get('content').get('isComplete')) {
        this.set('value', '/static/planner/en/d209fd25c40350ccadd36ca0c86d1e16759f42c2/source/resources/img/check.png')
      }else{
        this.set('value', '/static/planner/en/d209fd25c40350ccadd36ca0c86d1e16759f42c2/source/resources/img/uncheck.png')
      }
    }
  }),
  title: SC.LabelView.design({
    layout: {width: .9, height: .9, left: .1, top:.05},
    value: function(){
...
Planner.WeekCellView = SC.View.extend({
  ...
  render: function(){
    ...
    for(var i = 0; i < this.get('events').get('length'); i++){
      view = Planner.EventView.create({content: this.get('events').objectAt(i), num: i});
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/d209fd25c40350ccadd36ca0c86d1e16759f42c2/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/d209fd25c40350ccadd36ca0c86d1e16759f42c2/source/resources/img/ajax-loader.gif',
      })
    }),
