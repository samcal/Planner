...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/check.png');
  }
})
...
Planner.EventView = Planner.Wrapper.extend({
  ...
  top: function(){
    return this.get('parentView').get('eventTopOffset')*this.get('listHeight')*this.get('index') + this.get('height')*this.get('index');
  }.property(),
  height: function(){
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/e0f209fe722c702aec088fb9596edb36559359aa/source/resources/img/ajax-loader.gif',
      })
    }),
