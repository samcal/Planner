...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/check.png');
  }
})
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/f625dc946032509f0c53fe5b5595aa11e4c2f2cc/source/resources/img/ajax-loader.gif',
      })
    }),
...
Planner.plannerPage = SC.Page.design({
  ...
  plannerPane: SC.MainPane.design({
    ...
    sideView: SC.View.design({
      ...
      eventList: Planner.EventList.design({
        classNames: 'event-list',
        eventsBinding: SC.Binding.from('Planner.EventListController.events'),
        eventLeftOffset: .025,
        eventTopOffset: .02,
