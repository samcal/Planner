...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    this.get('parentView').adjust({
    	height: this.get('eventTopOffset')*this.get('currentHeight')*2 + this.get('numEvents')*(this.get('currentHeight')*(this.get('eventHeight')*this.get('eventSpacing')))
    });
    return YES;
  }.observes('events')
});
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/88bea7d033d2fa6885c9267be756e8917fc8e530/source/resources/img/ajax-loader.gif',
      })
    }),
