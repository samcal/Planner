...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/check.png');
  }
})
...
Planner.CheckImage = SC.ImageView.extend({
  ...
  build: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/check.png');
    else this.set('value', '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/uncheck.png');
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  requiredProperties: 'eventsCreated eventViews eventOrder events numEvents eventLeftOffset eventTopOffset eventHeight eventWidth currentHeight'.w(),
	...
	*/
    ...
    this.get('parentView').get('parentView').forceDimensionsRecalcultion();
   return YES;
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/9564e3dd87c245689f0376fa4f80b1a943965475/source/resources/img/ajax-loader.gif',
      })
    }),
