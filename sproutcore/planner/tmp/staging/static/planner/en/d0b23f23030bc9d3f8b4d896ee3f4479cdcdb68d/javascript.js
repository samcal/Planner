...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/check.png')
    }else{
      this.set('value', '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/uncheck.png')
    }
  },
  mouseDown: function(){
  ...
  switchComplete: function(isComplete){
    if(isComplete) this.set('value', '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/uncheck.png');
    if(!isComplete) this.set('value', '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/check.png');
  }
})
...
Planner.EventListContent = Planner.Wrapper.extend({
  ...
  currentHeight: function(){
    SC.info(this);
    SC.info(Planner.Utility.id(this));
    SC.info($(Planner.Utility.id(this)).css('height'))
  ...
  loginPane: SC.MainPane.design({
    ...
    loginBin: Planner.LoginView.design({
      ...
      bearImage: SC.ImageView.design({
        ...
        value: '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/banner.png',
      }),
      ...
      spinner: SC.ImageView.design({
        ...
        useCanvas: NO,
        value: '/static/planner/en/d0b23f23030bc9d3f8b4d896ee3f4479cdcdb68d/source/resources/img/ajax-loader.gif',
      })
    }),
