...
Planner.WeekCheckImage = SC.ImageView.extend({
  ...
  render: function(){
    ...
    if(this.get('parentView').get('content').get('isComplete')) {
      this.set('value', '/static/planner/en/current/source/resources/img/check.png?1334120252')
    }else{
      this.set('value', '/static/planner/en/current/source/resources/img/uncheck.png?1334120529')
    }
  },
  mouseDown: function(){
