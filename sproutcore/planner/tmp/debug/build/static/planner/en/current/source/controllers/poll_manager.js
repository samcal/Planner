...
Planner.pollRequest = SC.Request.getUrl('/poll/').json().notify(Planner.pollManager, 'pollDidRespond');; if ((typeof SC !== 'undefined') && SC && SC.Module && SC.Module.scriptDidLoad) SC.Module.scriptDidLoad('planner');